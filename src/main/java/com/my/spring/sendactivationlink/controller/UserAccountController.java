package com.my.spring.sendactivationlink.controller;
...
import com.my.spring.sendactivationlink.repository.ConfirmationTokenRepository;
import com.my.spring.sendactivationlink.repository.UserRepository;
import com.my.spring.sendactivationlink.service.EmailService;
...
public class UserAccountController {
	...
	public ModelAndView registerUser(ModelAndView modelAndView, UserEntity userEntity) {
		...
		if (existingUser != null) {
			...
			mailMessage.setFrom("your email is here"); //example@xyz.com
